...
def learn_f0_kmeans(f0_path, output_dir, visualize=False, n_clusters=8, batch_size=10000, max_no_improvement=100, max_iter=300, n_init=20):
    ...
    km_model = KMeans(n_clusters=n_clusters, max_iter=max_iter)
    ...
    # save kmeans model 
    km_path = os.path.join(output_dir, "kmeans_f0.pkl")
